(function($) {
  ...
  $.fn.mauGallery.methods = {
    ...
    showItemTags(gallery, position, tags) {
      var tagItems =
        '<li class="nav-item"><button class="nav-link active active-tag" data-images-toggle="all" role="tab" aria-selected="true"  aria-label="Afficher toutes les photographies" tabindex="0">Tous</button></li>';
